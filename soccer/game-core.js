...
(function (root, factory) {
  ...
  var TUNING = {
    player: {
      ...
      stunTicks: 40,      // 발차기에 맞으면 2초 기절 (2026-08-25 사용자 지시)
    ...
    kick: {
      freezeTicks: 1,     // 발차기(공 없이 D) 시전자 정지 0.05초 (4차 지시로 2 → 1)
      // **슛과 방귀는 정지가 더 길다** — 3차 지시 "딜레이 1.3배". 2 × 1.3 = 2.6 이지만 틱은 정수라 3틱(0.15초)으로 올림했다.
      // 이 정지가 "쏘는 순간 역공당하는" 타이밍 싸움을 만든다.
      shootFreezeTicks: 2,   // 슛 0.10초 (4차 지시로 3 → 2)
      fartFreezeTicks: 2,    // 방귀 0.10초 (4차 지시로 3 → 2)
      animTicks: 5,       // 동작 0.25초
      hitTick: 5,         // 누른 그 틱에 바로 판정한다(kickT === animTicks)
      cdTicks: 12,        // 앞차기 쿨다운 0.6초 — 헛치면 손해
      fartCdTicks: 8,     // 방귀 쿨다운 0.4초 (10차 지시로 16 → 8. 앞차기 0.6초보다 짧다)
